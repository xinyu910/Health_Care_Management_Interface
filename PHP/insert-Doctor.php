...
<meta name="description" content="Insert Doctor Page">
...
<form class="box" action="process-insert-Doctor.php" method="post"> 
<br>
<br>
<label>Doctor ID</label>
<br>
<input name="ID" type="number" placeholder="Enter Doctor ID" required>
<br>
<br>
<br>
...
<br>
<input name="Specialization" type="text" placeholder="Enter Specialization">
<br>
<br>
<br>
...
<input style="background: #c5e9e7; margin-left: 20px;
  ...
  width: 200px; color: black;" type="submit" value="Add the Doctor">
  <br>
  <br>
  <br>
</form>
