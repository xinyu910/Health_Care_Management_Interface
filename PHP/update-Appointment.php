...
<form class="box" action="update-Appointment 2.php" method="post">
<br>
<br>
<label>Select an Appointment to Update:</label>
<br>
<?php
include 'connect.php';
$conn = OpenCon();
...
<input style="background: #c5e9e7; margin-left: 20px;
  ...
  width: 300px; color: black;" type="submit" value="Update Selected Appointment">
  <br>
  <br>
  <br>
</form>
