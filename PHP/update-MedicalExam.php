...
<meta name="description" content="Update MedicalExam Page">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            ...
            <div class="carousel-caption">
                <hr class="solid">
                <h1 class="display-3">Update A Medical Exam</h1>
                <hr class="solid">
            </div>
        </div>
</div>

<form class="box" action="process-update-MedicalExam.php" method="post">
<br>
<br>
<br>
<?php
...
$id = $_POST['type'];
$conn = OpenCon();
$result = $conn->query("SELECT * FROM MedicalExamFee WHERE Type = '$id'");
echo "<label>You are updating the Medical Exam with Type = $id</label>";
$defaultType;
$defaultPrice;
...
<br>
<br>
<label>New Medical Exam Type</label>
<br>
<input name="Type" type="text" placeholder="Enter Type" value="<?php echo $defaultType;?>" required>
<br>
<br>
<br>
...
<br>
<input name="Price" type="number" step = "any" placeholder="Enter the Price" value="<?php echo $defaultPrice;?>" required>
<br>
<br>
<br>
...
<input style="background: #c5e9e7; margin-left: 20px;
  ...
  width: 200px; color: black;" type="submit" value="Update Medical Exam">
  <br>
  <br>
  <br>
</form>
