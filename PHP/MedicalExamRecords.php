...
<meta name="description" content="View Medical Exam Records Page">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            ...
            <div class="carousel-caption">
                <hr class="solid">
                <h1 class="display-3">View Medical Exam Records</h1>
                <hr class="solid">
            </div>
        </div>
</div>
...
<table class="table text-center">
  ...
  <tbody>
    ...
    while($row = $result->fetch_assoc()) { 
      ...
      <form class='box1' action='update-MedicalExamRecord.php' method='post'>
      <td>
      <input type='hidden' value=".$row['TestID']." name='TestID'> 
      ...
      <form class='box2' action='process-delete-MedicalExamRecord.php' method='post'>
      <input type='hidden' value=".$row['TestID']." name='TestID'> 
      <td>
...
<form class='insertBox' action='insert-MedicalExamRecord.php' method='post'>
<button style="background: #c5e9e7; margin-left: 20px;
  border: 1px solid #c5e9e7; padding: 7px 5px;
  width: 250px; color: black;" type="submit" type='button' class="btn btn-secondary">Insert A Medical Exam Record</button>
</form>
</div>
<br>
<br>
