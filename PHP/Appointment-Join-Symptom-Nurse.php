...
include 'connect.php';
$conn = OpenCon();
$sql = "SELECT A.AppointmentID, A.StartDateTime, A.EndDateTime, A.RoomNumber, A.PHN, A.DoctorID, 
...
<form class='switch' action='Appointment-Join-Symptom-Nurse-No-Name.php' method='post'>
<button style="background: #c5e9e7; margin-left: 20px;
  border: 1px solid #c5e9e7; padding: 7px 5px;
  width: 320px; color: black;" type="submit" type='button' class="btn btn-secondary">Hide Names</button>
</form>
</div>
<br>
<br>
  ...
  <thead>
    <tr>
     <th scope="col">#</th>
      ...
      <th scope="col">Supervising Nurse</th>
    </tr>
  </thead>
  <tbody>
