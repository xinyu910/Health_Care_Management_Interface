...
<meta name="description" content="Delete Appointments Page">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            ...
            <div class="carousel-caption">
                <hr class="solid">
                <h1 class="display-3">Delete A Doctor</h1>
                <hr class="solid">
            </div>
        </div>
</div>

<form class="box" action="process-Delete-Doctor.php" method="post">
</br>
</br>
<label>Delete Doctor by ID</label>
<br>
<?php
include 'connect.php';
$conn = OpenCon();
$result = $conn->query("select DoctorID from Doctor");
...
echo '<option value="'.$DoctorID.'">'.$DoctorID.'</option>';
}
echo "</select>";
?>
<br>
...
<input style="background: #c5e9e7; margin-left: 20px;
  ...
  width: 200px; color: black;" type="submit" value="Delete Doctor">
</form>
<br>
<br>