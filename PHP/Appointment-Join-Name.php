...
include 'connect.php';
$conn = OpenCon();
$sql = "SELECT A.AppointmentID, A.StartDateTime, A.EndDateTime, A.RoomNumber, A.PHN, A.DoctorID, P.Name AS PatientName, D.Name AS DoctorName
...
<form class='Filter Rows' action='Filter-Appointment.php' method='post'>
<button style="background: #c5e9e7; margin-left: 20px;
  border: 1px solid #c5e9e7; padding: 7px 5px;
  width: 150px; color: black;" type="submit" type='button' class="btn btn-secondary">Filter Rows</button>
</form>
<br>
<form class='Filter Columns' action='projection-Appointment.php' method='post'>
<button style="background: #c5e9e7; margin-left: 20px;
  border: 1px solid #c5e9e7; padding: 7px 5px;
  width: 150px; color: black;" type="submit" type='button' class="btn btn-secondary">Filter Columns</button>
</form>
</div>
<br>
<br>
<div class="btn-group" role="group" aria-label="Button_Groups">
<form class='switch' action='Appointment.php' method='post'>
<button style="background: #c5e9e7; margin-left: 20px;
  border: 1px solid #c5e9e7; padding: 7px 5px;
  width: 320px; color: black;" type="submit" type='button' class="btn btn-secondary">Hide Patient Name and Doctor Name</button>
</form>
<form class='switch2' action='Appointment-Join-Symptom-Nurse.php' method='post'>
<button style="background: #c5e9e7; margin-left: 20px;
  border: 1px solid #c5e9e7; padding: 7px 5px;
  width: 320px; color: black;" type="submit" type='button' class="btn btn-secondary">Show Symptom and Nurse</button>
</form>
</div>
<br>
<br>
<table class="table text-center" >
  ...
  <tbody>
    ...
    while($row = $result->fetch_assoc()) { 
      ...
      <td>".$patient."</td>
      <td>".$doctor."</td>
      <form class='box1' action='update-Appointment 2.php' method='post'>
      <td>
      <input type='hidden' value=".$row['AppointmentID']." name='appointmentID'> 
      ...
      <form class='box2' action='process-delete-Appointment.php' method='post'>
      <input type='hidden' value=".$row['AppointmentID']." name='AppointmentID'> 
      <td>
...
<div class="btn-group" role="group" aria-label="Button_Groups">
<form class='insertBox' action='insert-Appointment.php' method='post'>
<button style="background: #c5e9e7; margin-left: 20px;
  border: 1px solid #c5e9e7; padding: 7px 5px;
  width: 200px; color: black;" type="submit" type='button' class="btn btn-secondary">Insert An Appointment</button>
</form>
<form class='updateBox' action='update-Appointment.php' method='post'>
<button style="background: #c5e9e7; margin-left: 20px;
  border: 1px solid #c5e9e7; padding: 7px 5px;
  width: 200px; color: black;" type="submit" type='button' class="btn btn-secondary">Update An Appointment</button>
</form>
<form class='deleteBox' action='delete-Appointment.php' method='post'>
<button style="background: #c5e9e7; margin-left: 20px;
  border: 1px solid #c5e9e7; padding: 7px 5px;
  width: 200px; color: black;" type="submit" type='button' class="btn btn-secondary">Delete An Appointment</button>
</form>
</div>
</div>
<br>
