...
<form class="box" action="process-update-Doctor.php" method="post">
<br>
<br>
<br>
<?php
...
echo "<label>You are updating the Doctor with ID = $id</label>";
$defaultDoctorID;
$defaultName;
$defaultAge;
$defaultGender;
$defaultSpecilization;
while ($row = $result->fetch_assoc())
{
    ...
    $defaultSpecilization = $row["Specialization"];
}
...
<br>
<input name="ID" type="number" placeholder="Enter Doctor ID" value="<?php echo $defaultDoctorID;?>" required>
<br>
<br>
<br>
...
<label>New Age</label>
<br>
<input name="Age" type="number" placeholder="Enter the Age" value="<?php echo $defaultAge;?>" >
<br>
<br>
<br>
...
<br>
<input name="Specialization" type="text" placeholder="Enter the Specialization" value="<?php echo $defaultSpecilization;?>" >
<br>
<br>
<br>
...
<input style="background: #c5e9e7; margin-left: 20px;
  ...
  width: 200px; color: black;" type="submit" value="Update Doctor">
  <br>
  <br>
  <br>
</form>
