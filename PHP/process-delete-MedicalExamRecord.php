...
<meta name="description" content="Delete MedicalExamRecord Page">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            ...
            <div class="carousel-caption">
                <hr class="solid">
                <h1 class="display-3">Delete A Medical Exam Record</h1>
                <hr class="solid">
            </div>
        </div>
</div>
...
$id = $_POST['TestID'];
$conn = OpenCon();
$sql = "DELETE FROM MedicalExamsIncludedIn WHERE TestID = '$id'";
