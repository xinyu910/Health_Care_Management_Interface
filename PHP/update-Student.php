...
<form class="box" action="process-update-Student.php" method="post">
<br>
<br>
<br>
<?php
...
$result2 = $conn->query("SELECT StudentNumber FROM Students WHERE StudentPHN = '$id'");
while ($row = $result2->fetch_assoc())
{
    $defaultStudentNumber = $row["StudentNumber"];
}
?>
...
<br>
<input name="StudentNumber" type="number" placeholder="Enter Student Number" value="<?php echo $defaultStudentNumber;?>" required>
<br>
<br>
<br>
