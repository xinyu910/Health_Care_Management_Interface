...
$Type = $_POST['Type'];
$sqlTest = "update MedicalExamsIncludedIn set TestID = '$TestID' where TestID = '$id'";
$sqlResult = "update MedicalExamsIncludedIn set Results = '$Result' where TestID = '$id'";
$sqlID = "update MedicalExamsIncludedIn set AppointmentID = '$AppointmentID' where TestID = '$id'";
$sqlType = "update MedicalExamsIncludedIn set Type = '$Type' where TestID = '$id'";

if ($conn->query($sqlTest) === TRUE && $conn->query($sqlResult) === TRUE && 
    $conn->query($sqlID) === TRUE && $conn->query($sqlType) === TRUE) { echo "<p style='text-align: center; font-weight: 350;
