...
$Type = $_POST['Type'];
$Price = $_POST['Price'];
$sqlPrice = "update MedicalExamFee set Price = '$Price' where Type = '$id'";
$sqlType = "update MedicalExamFee set Type = '$Type' where Type = '$id'";

if ($conn->query($sqlPrice) === TRUE && $conn->query($sqlType) === TRUE) { 
