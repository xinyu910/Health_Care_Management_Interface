...
<meta name="description" content="Insert MedicalExamRecord Page">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            ...
            <div class="carousel-caption">
                <hr class="solid">
                <h1 class="display-3">Add A Medical Exam Record</h1>
                <hr class="solid">
            </div>
        </div>
</div>

<form class="box" action="process-insert-MedicalExamRecord.php" method="post"> 
<br>
<br>
<label>Exam ID</label>
<br>
<input name="ExamID" type="number" placeholder="Enter Exam ID" required>
<br>
<br>
<br>
...
<label>Result</label>
<br>
<input name="Result" type="text" placeholder="Enter the Result" required>
<br>
<br>
<br>
...
<input style="background: #c5e9e7; margin-left: 20px;
  ...
  width: 200px; color: black;" type="submit" value="Add the Record">
  <br>
  <br>
  <br>
</form>
