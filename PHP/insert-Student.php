    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            ...
            <div class="carousel-caption">
                <hr class="solid">
                <h1 class="display-3">Add A Student Patient</h1>
                <hr class="solid">
            </div>
        </div>
</div>

<form class="box" action="process-insert-Student.php" method="post"> 
<br>
<br>
<label>PHN</label>
<br>
...
<br>
<input name="Student" type="number" placeholder="Enter Student Number" required>
<br>
<br>
<br>
...
<input style="background: #c5e9e7; margin-left: 20px;
  ...
  width: 200px; color: black;" type="submit" value="Add the Student">
  <br>
  <br>
  <br>
</form>
