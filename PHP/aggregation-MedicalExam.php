...
<form class='box' action="process-aggregation-MedicalExam.php" method="post"> 
<hr class="solid" style="width: 300px; border-top: 1px solid rgb(0, 0, 0);">
Calculate the Total Cost of The Medical Exams Selected
<hr class="solid" style="width: 300px; border-top: 1px solid rgb(0, 0, 0);">
</br>
</br>
<?php
...
unset($Type);
$Type = $row['Type'];
echo'<input type="checkbox" value="'.$Type.'" name="checkbox[]"/>
     <label>'.$Type.'</label><br>';
}
...
<input style="background: #c5e9e7; margin-left: 20px;
  ...
  width: 200px; color: black;" type="submit" value="Calculate Cost">
  <br>
  <br>
</form>
</body>
