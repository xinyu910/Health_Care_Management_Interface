...
if (isset($_POST['Age']) && !empty($_POST['Age'])) {
    $Age = $_POST['Age'];
    $sql = "INSERT INTO Doctor (DoctorID, Name, Age, Gender, Specialization)
VALUES ('$DoctorID', '$Name', '$Age', '$Gender', '$Specialization')";
} else {
    $sql = "INSERT INTO Doctor (DoctorID, Name, Gender, Specialization)
...
TRUE) { echo "<p style='text-align: center; font-weight: 350;
    ...
    $sentence ="Error inserting the doctor: " . $conn->error;
