...
<meta name="description" content="Update Public Page">
...
<form class="box" action="process-update-Public.php" method="post">
<br>
<br>
<br>
<?php
...
$result2 = $conn->query("SELECT SSN FROM GeneralPublic WHERE PublicPHN = '$id'");
...
<label>New SSN</label>
<br>
<input name="SSN" type="number" placeholder="Enter SSN" value="<?php echo $defaultSSN;?>" required>
<br>
<br>
<br>
