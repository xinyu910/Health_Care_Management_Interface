    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            ...
            <div class="carousel-caption">
                <hr class="solid">
                <h1 class="display-3">View Filtered Appointments</h1>
                <hr class="solid">
            </div>
        </div>
</div>
...
if (isset($_POST['checkbox'])) {
    $roomNumber = $_POST['checkbox'];
    $roomNumbers = join("','",$roomNumber);
} else {
    $roomNumber = array();
    $sqlRoom = "SELECT RoomNumber FROM Room";
...
if (isset($_POST['checkbox1'])) {
    ...
    $PHN = array();
    $sqlPHN = "SELECT PHN FROM Patients";
    $resultPHN = $conn->query($sqlPHN);
    while($row = $resultPHN->fetch_assoc()) {
        $PHN[] = $row['PHN'];
    }
    $PHNs = join("','",$PHN); 
}
...
if (isset($_POST['checkbox2'])) {
    $doctorID = $_POST['checkbox2'];
    $doctorIDs = join("','",$doctorID); 
} else {
    $doctorID = array();
    $sqlID = "SELECT DoctorID FROM Doctor";
...
if ($startDate != 0 && $endDate != 0) {
    $formattedStartDate = date('Y-m-d\TH:i:s', $startDate);
    $formattedEndDate = date('Y-m-d\TH:i:s', $endDate);
