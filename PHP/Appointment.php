...
<button style="background: #c5e9e7; margin-left: 20px;
  border: 1px solid #c5e9e7; padding: 7px 5px;
  width: 320px; color: black;" type="submit" type='button' class="btn btn-secondary">Show Patient Name and Doctor Name</button>
</form>
<form class='switch2' action='Appointment-Join-Symptom-Nurse-No-name.php' method='post'>
<button style="background: #c5e9e7; margin-left: 20px;
  border: 1px solid #c5e9e7; padding: 7px 5px;
